...
export default function InfoWindow() {
  ...
  useEffect(() => {
    ...
    DOMTargetList[DOMID_IMAGE_SLIDER] =
      document.getElementById(DOMID_IMAGE_SLIDER);
    DOMTargetList[DOMID_POP_UP_WINDOW] =
      document.getElementById(DOMID_POP_UP_WINDOW);
  }, [contents]);

  return (
    <PopUpWindow.Layout
      data-testid={DOMID_POP_UP_WINDOW}
      id={DOMID_POP_UP_WINDOW}
      tabState={tabState}
    >
        ...
        <BlurFrame id={DOMID_BLURFRAME} tabState={tabState}>
          <S.TopSection>
            ...
            <S.ImageSliderWrapper id={DOMID_IMAGE_SLIDER}>
              <MakeLodableSuspense
                lodableState={state}
                loading={<CustomImageSliderSkeleton />}
              >
                <ImageListTab
          ...
          <S.Section>
            ...
            <MapButtonList.List>
              <MapButtonList.Button
                onClick={() =>
                  contents.naverMapUrl && window.open(contents.naverMapUrl)
                }
              >
                네이버지도 길찾기
              </MapButtonList.Button>
              <MapButtonList.Button
                onClick={() =>
                  contents.kakaoMapUrl && window.open(contents.kakaoMapUrl)
                }
              >
                카카오맵 길찾기
              </MapButtonList.Button>
